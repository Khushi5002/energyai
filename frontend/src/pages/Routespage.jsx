  ...
  return (
    <div>
      <header className="mb-8">
        <h1 className="font-display text-2xl font-semibold">Shipping Routes</h1>
      ...
      <div className="rounded-xl overflow-hidden mb-6" style={{ height: 400, border: "1px solid var(--panel-border)" }}>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-5 gap-4">
        {routes.map((r, i) => (
          <div key={i} className="rounded-xl p-4" style={{ background: "var(--panel)", border: "1px solid var(--panel-border)" }}>
